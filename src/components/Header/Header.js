                ...
                <nav className="bg-white py-2 md:py-4 border-b-2">
                    <div className="container px-4 mx-auto md:flex md:items-center">
                        ...
                        <div className="flex justify-between items-center">
                            <NavLink to="#" className="font-bold text-xl text-indigo-600 font-serif">MKS&Tech</NavLink>
                        ...
                        <div className="hidden md:flex flex-col md:flex-row md:ml-auto mt-3 md:mt-0" id="navbar-collapse">
                            ...
                            <NavLink to="#" className="p-2 lg:px-4 md:mx-2 text-gray-600 rounded hover:bg-gray-200 hover:text-gray-700 transition-colors duration-300">Gallery</NavLink>

                            <NavLink to="/login" activeStyle={activeStyle} className="p-2 lg:px-4 md:mx-2 text-indigo-600 text-center border border-transparent rounded hover:bg-indigo-100 hover:text-indigo-700 transition-colors duration-300">Login</NavLink>

                            <NavLink to="/signup" activeStyle={activeStyle} className="p-2 lg:px-4 md:mx-2 text-indigo-600 text-center border border-solid border-indigo-600 rounded hover:bg-indigo-600 hover:text-white transition-colors duration-300 mt-1 md:mt-0 md:ml-1">Signup</NavLink>
                        </div>
                    </div>
                </nav>
